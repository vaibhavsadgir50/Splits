...
// Exposed for the profile avatar picker (choose any memoji, not just the
// deterministic default) and for server-side validation of picked paths.
export const MEMOJI_FILES = ALL_MEMOJIS
